...
The output conforms to the HTML5 standard (or tries to).  The output contains a minimum of formatting
information.  The cascading style sheet "html5css3.css" is required
...
class Writer(writers.Writer):
    ...
    config_section = 'html5css3 writer'
...
class HTML5Translator(nodes.NodeVisitor):
    ...
    head_prefix_template = ('<head lang="%(lang)s">\n')
    ...
    def __init__(self, document):
        super(HTML5Translator, self).__init__(document)
